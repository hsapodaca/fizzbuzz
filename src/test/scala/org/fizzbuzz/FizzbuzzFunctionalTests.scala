...
// covers functionality (6 fizzbuzzes * each of the numbers specified below in lists) = 116 tests with 39 lines of code
class FizzbuzzFunctionalTests extends FeatureSpec with GivenWhenThen with Matchers with FizzbuzzTests {
  ...
  lazy val tests: Iterable[TestCase] = Map(
    ...
    List(0, -15, 15, 30, 45, 15000000) -> "Fizzbuzz",
    List(-1, 1, 2, 44, 1000001, -11111111) -> "String representation of a number"
